        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <div className="prose prose-lg text-muted-foreground">
              <p className="mb-6">
                Founded in 2000, YANNOS ASFALTIKA LTD began as a small
                family-owned operation with a single vision: to provide the
                highest quality asphalt products and paving services in the
                region. Over the past two decades, we have evolved into one of
                the industry's leaders.
              </p>
              <p className="mb-6">
                Our growth has been fueled by our unwavering commitment to
                quality, investment in modern machinery, and continuous training
                of our personnel. Today, we operate a state-of-the-art asphalt
                mixing plant and maintain a large fleet of specialized
                construction vehicles.
              </p>
              <p>
                We take pride in our ability to handle projects of any scale,
                from small private driveways to large public infrastructure
                networks, always delivering on time and exceeding expectations.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 my-24 border-y border-gray-100 py-12">
          {stats.map((stat, i) => (
            <div key={i} className="text-center">
              ...
              <div className="text-secondary font-medium uppercase tracking-wide text-sm">
                {stat.label}
              </div>
            </div>
          ))}
            ...
            {[
              ...
              >
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-xl font-bold text-secondary mb-4 uppercase">
                    {value.title}
                  </h3>
